...
function format(lines) {
    ...
    lines.forEach((line)=>{
        ...
        innerText.forEach((word)=>{
            if ((0, _blocksJsDefault.default).hasOwnProperty(word)) {
                let wordRange = document.createRange();
                let blockType = (0, _blocksJsDefault.default)[word].opcode.split("_")[0];
                ...
                let wordRange1 = document.createRange();
                let span1 = document.createElement("span");
                span1.classList.add("normal-text");
                wordRange1.setStart(line, offset);
                if (offset + word.length - 1 > 0) wordRange1.setEnd(line, offset + word.length - 1);
                else wordRange1.setEnd(line, 0);
                textNodes.push({
                    wordRange: wordRange1,
                    span: span1
                });
            }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../lib/blocks.js":"kSYJ1"}],"gkKU3":[function(require,module,exports) {
...
},{}],"kSYJ1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8LntH","1KzgX"], "1KzgX", "parcelRequire94c2")
