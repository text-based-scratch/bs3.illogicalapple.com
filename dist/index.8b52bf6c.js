...
var Common = function() {
    ...
    parseSearch(function(key, value) {
        function setPlayerOption(name, value) {
            ...
            if (!DEFAULT_OPTIONS.hasOwnProperty(name)) throw new Error("Unknown option: " + name);
            ...
            if (expectedType === "boolean") {
                ...
                if (TRUE.indexOf(value) > -1) value = true;
                else if (FALSE.indexOf(value) > -1) value = false;
                else {
        ...
        function setPlayerEnum(name, value, values) {
            if (values.indexOf(value) > -1) setPlayerOption(name, value);
            else console.warn(value, "is not one of", values.join(", "));
        }
        switch(key){
            // Player options
            case "fps":
            ...
            case "limits":
                ...
                break;
            case "cloud":
                setPlayerEnum("cloudVariables", value, [
                    "off",
                    "ws",
                    "localStorage"
                ]);
...
//# sourceMappingURL=index.8b52bf6c.js.map
